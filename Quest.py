...
class CollectQuest(Quest):
	def __init__(self, name: str, giver: str,
		...
		super().__init__(name, QuestType.Collect, giver, coin_reward, exp_reward, object_reward, description, repeatable)
...
class AssassinateQuest(Quest):
	def __init__(self, name: str, giver: str,
		...
		super().__init__(name, QuestType.Assassinate, giver, coin_reward, exp_reward, object_reward, description, repeatable)
		self.target = target
		if self.name not in Quest.names:
			Quest.names.append(self.name)
			Quest.all.append(self)
